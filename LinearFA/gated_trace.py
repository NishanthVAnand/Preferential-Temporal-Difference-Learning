...
if args.env == "simpleChain":
	filename = "gated_trace"+"_env_"+str(args.env)+"_len_"+str(args.len)+"_lr_"+str(args.lr)+"_seed_"+str(args.seed)
	...
	filename = "gated_trace"+"_env_"+str(args.env)+"_lr_"+str(args.lr)+"_seed_"+str(args.seed)
